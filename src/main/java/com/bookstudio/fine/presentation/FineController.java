...
public class FineController {
    ...
    public ResponseEntity<ApiSuccess<FineDetailResponse>> get(@PathVariable Long id) {
    ...
    public ResponseEntity<ApiSuccess<FineListResponse>> update(@PathVariable Long id,
