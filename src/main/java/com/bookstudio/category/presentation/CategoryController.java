...
public class CategoryController {
    ...
    public ResponseEntity<ApiSuccess<CategoryDetailResponse>> get(@PathVariable Long id) {
    ...
    public ResponseEntity<ApiSuccess<CategoryListResponse>> update(@PathVariable Long id,
